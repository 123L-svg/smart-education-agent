package com.smarteducation.aigc.service.impl;
...
import com.smarteducation.aigc.config.SessionProperties;
import com.smarteducation.aigc.entity.ChatSession;
import com.smarteducation.aigc.enums.MessageTypeEnum;
import com.smarteducation.aigc.mapper.ChatSessionMapper;
import com.smarteducation.aigc.memory.MyAssistantMessage;
import com.smarteducation.aigc.service.ChatService;
import com.smarteducation.aigc.service.ChatSessionService;
import com.smarteducation.aigc.vo.ChatSessionVO;
import com.smarteducation.aigc.vo.MessageVO;
import com.smarteducation.aigc.vo.SessionVO;
    ...
    public List<MessageVO> queryBySessionId(String sessionId) {
        ...
        return StreamUtil.of(messageList)
                ...
                .map(message -> {
                    ...
                    return MessageVO.builder()
                            .content(message.getText())  // 用户消息
                            .type(MessageTypeEnum.valueOf(message.getMessageType().name()))  // 用户消息
                            .build();
                })
                .toList();
    }
