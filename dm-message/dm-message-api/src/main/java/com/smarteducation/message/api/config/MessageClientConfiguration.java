package com.smarteducation.message.api.config;
...
import static com.smarteducation.common.constants.Constant.*;

@Configuration
@EnableFeignClients(basePackages = "com.smarteducation.message.api.client")
