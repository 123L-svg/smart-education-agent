package com.smarteducation.promotion.domain.vo;

import com.smarteducation.common.utils.DateUtils;
import com.smarteducation.promotion.enums.DiscountType;
...
public class CouponDetailVO {
    ...
    @Schema(description = "优惠券使用范围，key范围类型(0-没有限制，1-限定分类，2-限定课程)，值是范围ID")
